...
**Figure 1.**  Annual juvenile hare observations during 1998 - 2012 at Bonanza Creek LTER, Alaska.  Kielland, et al. (2017).  The juvenile hare observation stats were `r hares_max` max., `r hares_min` min., `r hares_med` median, and `r hares_mean` mean.
...
ggplot(data = hares_juv, aes(x = hindft, y = weight, color = sex)) +
  geom_point() +
  #geom_smooth(method = "lm",color = "red", size = 0.5, fill = "gray10", alpha = 0.5) +
